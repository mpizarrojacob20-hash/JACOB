...
- Si tiene acciones pendientes, recuérdaselas TODAS, no solo la más relevante — una
  línea por acción, directo y sin rodeos, para que sepa exactamente qué quedó sin avanzar.
- Si no tiene ninguna pendiente, invítalo a compartir números nuevos o resolver una duda
  puntual de gestión.
Máximo 5-6 líneas (una por acción pendiente, más apertura y cierre breves). Tono cercano,
como un socio que se preocupa por cómo le va — NO como una notificación automática. No
uses el formato de diagnóstico ESTADO 2 (nada de "1. Estado del negocio... 2. El
problema..."), esto es solo un saludo con gancho y el recordatorio de lo pendiente.`;
